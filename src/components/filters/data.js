const enumOfYears = [
  ...
  const maxYear = enumOfYears[0];
  const minYear = enumOfYears[enumOfYears.length - 1];

  const sortByValues = ['По популярности', "По рейтингу"];

  export {maxYear, minYear, sortByValues}